  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center flex-col lg:flex-row">
        <div className="flex lg:w-[420px] w-full flex-wrap h-[330px]">
          ...
          <div className="lg:w-[410px] w-full">
            <div className="text-white">Kiedy planujesz przylot?</div>
            <select
            ...
            >
              <option>do 12 września</option>
              <option>do 20 września</option>
              <option>do 30 września</option>
              <option>do 12 października</option>
              <option>do 20 października</option>
              <option>do 30 października</option>
              <option>Jestem w Hiszpanii</option>
            </select>
          </div>
        </div>
        <div>
          <div className="lg:w-[410px] w-full mt-[5px] lg:mt-0">
            ...
            <textarea
              className="lg:w-[410px] w-full rounded-[5px] h-[189px] md:h-[283px] "
              value={massege}
